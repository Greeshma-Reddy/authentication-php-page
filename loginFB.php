<?php
	...
	FacebookSession::setDefaultApplication( '336373777848389','6a335eff834f3ac8ff46e34bc044ce62' );
	$helper = new FacebookRedirectLoginHelper('http://localhost/111111111111/socialhome.php');
